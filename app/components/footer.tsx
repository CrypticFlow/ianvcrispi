      ...
      <div className="flex justify-center items-center py-4 px-6">
        <div className="flex space-x-6">
          ...
          <a
            ...
            className="social-icon transition-all duration-300 hover:scale-110 active:scale-95 p-2 touch-manipulation cursor-pointer"
            aria-label="Follow CrypticFlow on Instagram"
            title="Follow CrypticFlow on Instagram"
          >
            <svg className="w-6 h-6" fill="url(#gradient)" viewBox="0 0 24 24">
              <defs>
          ...
          {/* Spotify */}
          <a
            href="https://open.spotify.com/artist/3WpFCgtVy9sDtmCYmGcocE"
            target="_blank"
            rel="noopener noreferrer"
            className="social-icon transition-all duration-300 hover:scale-110 active:scale-95 p-2 touch-manipulation cursor-pointer"
            aria-label="Listen to CrypticFlow on Spotify"
            title="Listen to CrypticFlow on Spotify"
          >
            <svg className="w-6 h-6" fill="url(#gradient)" viewBox="0 0 24 24">
          ...
          <a
            ...
            rel="noopener noreferrer"
            className="social-icon transition-all duration-300 hover:scale-110 active:scale-95 p-2 touch-manipulation cursor-pointer"
            aria-label="Listen to CrypticFlow on SoundCloud"
            title="Listen to CrypticFlow on SoundCloud"
          >
            <svg className="w-6 h-6" fill="url(#gradient)" viewBox="0 0 24 24">
          ...
          <a
            ...
            rel="noopener noreferrer"
            className="social-icon transition-all duration-300 hover:scale-110 active:scale-95 p-2 touch-manipulation cursor-pointer"
            aria-label="Watch CrypticFlow on YouTube"
            title="Watch CrypticFlow on YouTube"
          >
            <svg className="w-6 h-6" fill="url(#gradient)" viewBox="0 0 24 24">
          ...
          <a
            ...
            rel="noopener noreferrer"
            className="social-icon transition-all duration-300 hover:scale-110 active:scale-95 p-2 touch-manipulation cursor-pointer"
            aria-label="Follow CrypticFlow on TikTok"
            title="Follow CrypticFlow on TikTok"
          >
            <svg className="w-6 h-6" fill="url(#gradient)" viewBox="0 0 24 24">
