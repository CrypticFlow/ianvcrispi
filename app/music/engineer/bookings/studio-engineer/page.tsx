        ...
        <div className="flex justify-center px-4 sm:px-20">
          <div className="w-full max-w-2xl">
            <div className="bg-white rounded-lg shadow-lg p-6">
              ...
              <iframe 
                src="https://cal.com/ian-crispi-ubsslh/booking-call-for-studio-engineer?embed=true&theme=light&hideEventTypeDetails=false&layout=month_view&primaryColor=ff6b6b&textColor=374151&backgroundColor=ffffff"
                width="100%" 
                height="630px"
                frameBorder="0"
